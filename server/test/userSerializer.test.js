...
const EXPECTED_FORBIDDEN_KEYS = [
  ...
  'correct_answer_text',
  'correctAnswerText',
  // The EXACT key PR2's admin-facing attempts.js already uses for the
  // plaintext correct answer (GET /api/attempts/:id → answers[].correctAnswer),
  // which makes it the single most likely accidental copy-paste leak into a
  // usuario-facing route. Both spellings, like every other entry here.
  'correct_answer',
  'correctAnswer'
]
